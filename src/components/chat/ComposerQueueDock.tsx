...
export function ComposerQueueDock({
  ...
  const frame =
    `aurora-glass ${dockedComposerCardMx} flex flex-col gap-[8px] overflow-hidden rounded-t-[var(--agent-composer-radius)] rounded-b-none border-x border-t border-[var(--border-card)] bg-[var(--bg-card)] p-[10px]`;
