...
export function ComposerAutocomplete({
  ...
  }, [items.length, listRef, selectedIndex]);
  ...
  return createPortal(
    ...
    >
      <div className="flex shrink-0 items-center gap-[6px] border-b border-[var(--border-card)] px-[10px] py-[6px]">
        <AtSign className="size-[13px] shrink-0 text-[var(--text-secondary)]" strokeWidth={1.5} />
        <span className="font-sans text-[13px] font-normal text-[var(--text-secondary)]">Context</span>
      </div>
