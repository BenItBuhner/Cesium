...
export const dockedComposerCardFrame =
  "mx-[var(--agent-composer-radius)] flex flex-col overflow-hidden rounded-t-[var(--agent-composer-radius)] rounded-b-none border-x border-t border-[var(--border-card)] bg-[var(--bg-card)] p-[10px]";
