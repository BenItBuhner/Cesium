...
export function PlanReviewDock({
  ...
  return (
    <div className="aurora-glass mx-[var(--agent-composer-radius)] rounded-t-[var(--agent-composer-radius)] rounded-b-none border-x border-t border-[var(--border-card)] bg-[var(--bg-card)] p-[10px]">
