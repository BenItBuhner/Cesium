/**
 * Language / MIME / explorer-dimming heuristics, ported from
 * `server/src/lib/workspace.ts` so the browser machine's file tree and
 * editor payloads match the real engine byte-for-byte.
 */
...
const LANGUAGE_BY_SUFFIX = new Map<string, string>([[".blade.php", "php"]]);
