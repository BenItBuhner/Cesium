 ...
 * them for RN/NativeWind. Runtime themes merge partials onto these defaults
 * and set them on `document.documentElement`.
 */
...
export type ThemeTokens = {
  ...
  "--goal-accent": string;
  "--goal-accent-dark": string;
  "--goal-accent-bg": string;
...
export const DEFAULT_THEME_TOKENS_LIGHT: ThemeTokens = {
  ...
  "--goal-accent": "#c43d32",
  "--goal-accent-dark": "#9f2f27",
  "--goal-accent-bg": "#f1dedb",
...
export const DEFAULT_THEME_TOKENS_DARK: ThemeTokens = {
  ...
  "--goal-accent": "#ff8a7a",
  "--goal-accent-dark": "#c94f43",
  "--goal-accent-bg": "#3a2927",
