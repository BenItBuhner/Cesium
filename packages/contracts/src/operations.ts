...
export const CESIUM_SDK_OPERATIONS = [
  ...
  operation("workspaces.insights", "GET", "/api/workspaces/:workspaceId/insights", "workspace"),
  ...
  operation("actions.list", "GET", "/api/actions"),
  operation("actions.upsertCustom", "PUT", "/api/actions/custom/:actionId"),
  operation("actions.removeCustom", "DELETE", "/api/actions/custom/:actionId"),
  operation("actions.presets", "PATCH", "/api/actions/presets"),
  operation("actions.run", "POST", "/api/actions/:actionId/run", "workspace"),
  ...
  operation("settings.voice.get", "GET", "/api/settings/voice"),
  operation("settings.voice.update", "PUT", "/api/settings/voice"),
  operation("settings.voice.remove", "DELETE", "/api/settings/voice"),
